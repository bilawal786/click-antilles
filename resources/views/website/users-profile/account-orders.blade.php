            ...
            <section class="col-lg-9 col-md-9">
                <div class="card box-shadow-sm">
                    <div style="overflow: auto">
                        <table class="table">
                            <thead >
                            <tr style="background-color: #0063d1;color: white">
                                <td class="tdBorder">
                                    <div class="py-2"><span
                            ...
                            @foreach($orders as $order)
                                <tr>
                                    ...
                                    <td class="bodytr">
                                        {{\App\CPU\Helpers::currency_converter($order['order_amount']-$summary['total_shipping_cost']-$summary['total_tax'])}}
                                    </td>
                                    <td class="bodytr">
                                        <a href="{{ route('account-order-detailss', ['id'=>$order->id]) }}"
