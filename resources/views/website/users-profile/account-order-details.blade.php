                ...
                <div class="card box-shadow-sm">
                    ...
                    <div class="payment mb-3  table-responsive">
                        ...
                        <table class="table table-borderless">
                            <thead>
                            <tr class="order_table_tr" style="background-color: #0063d1; color: white">
                            ...
                            <tr class="border-top border-bottom">
                                ...
                                <td>
                                    <div class="text-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}"><span
                                            class="font-weight-bold amount ">{{\App\CPU\Helpers::currency_converter($order->order_amount-$summary['total_shipping_cost']-$summary['total_tax'])}}</span>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
