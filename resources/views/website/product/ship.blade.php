...
@section('content')
    <?php $shipmentOptions = App\Model\ShipmentOption::all(); ?>
    {{--stripe--}}
                                                        ...
                                                        <div id="grid" class="tab-pane active" role="tabpanel">
                                                            <div class="woocommerce columns-5">
                                                                <section class="section-product-categories">
                                                                    ...
                                                                    <div class="row">
                                                                        @foreach($shipmentOptions as $shipmentOption)
                                                                            <form action="{{route('product-checkout')}}" class="checkout woocommerce-checkout" method="get"
                                                                                  name="checkout">
                                                                            <div class="col-10">
                                                                                <div class="woocommerce columns-5">
                                                                                    <div
                                                                                        class="product-loop-categories">
                                                                                        <div
                                                                                            class="order-review-wrapper">
                                                                                            <a href="#">
                                                                                                <h3 class="order_review_heading"
                                                                                                    style="text-align: center;">
                                                                                                    {{$shipmentOption->title}}</h3>
                                                                                                <table
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <th class="product-total">
                                                                                                            {{\App\CPU\Helpers::currency_converter($shipmentOption->price)}}
                                                                                                        </th>
                                                                                                    </tr>
                                                                                                    </thead>
                                                                                                    <tbody>
                                                                        ...
                                                                        <span class="woocommerce-Price-amount amount">
                                                                            <span
                                                                                class="woocommerce-Price-currencySymbol"></span> {{\App\CPU\Helpers::currency_converter(($cartItem['price']-$cartItem['discount'])*$cartItem['quantity'])}}</span>
                                                                                                            ...
                                                                                                            @php($sub_total+=(($cartItem['price']-$cartItem['discount'])*$cartItem['quantity'])+$shipmentOption->price)
                                                                            ...
                                                                            <span
                                                                                ...
                                                                                <span
                                                                                    class="woocommerce-Price-currencySymbol"></span>{{\App\CPU\Helpers::currency_converter($sub_total) ?? 0}}</span>
                                                                                                ...
                                                                                                <input type="submit" style="width: 100%" value="Order" class="btn btn-primary">
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <input type="hidden" name="shippingPrice" id="shippingPrice" value="{{$shipmentOption->price}}">
                                                                            </form>
                                                                        @endforeach
                                                                    </div>
                                                                    <!-- .woocommerce -->
...
{{--                                                        <a href="{{route('product-checkout')}}" id="checkout-button"--}}
{{--                                                           class="button wc-forward text-center">SHIPMENT CMA-CGM--}}
{{--                                                        </a>--}}
